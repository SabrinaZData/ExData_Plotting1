...
#save plot4 to working directory
png(filename = "plot4.png", width = 480, height = 480)
par(mfrow = c(2, 2))
plot(hh_power_data$DateTime, hh_power_data$Global_active_power, type="l", xlab = "", ylab = "Global Active Power")
plot(hh_power_data$DateTime, hh_power_data$Voltage, type="l", xlab = "datetime", ylab = "Voltage")

plot(hh_power_data$DateTime, hh_power_data$Sub_metering_1, type = "l", col = "black", xlab = "", ylab = "Energy sub metering")
lines(hh_power_data$DateTime, hh_power_data$Sub_metering_2, col = "red")
lines(hh_power_data$DateTime, hh_power_data$Sub_metering_3, col = "blue")
legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty = 1, cex=0.8)

plot(hh_power_data$DateTime, hh_power_data$Global_reactive_power, type="l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()
